...
import DocSvg from "./undraw_medicine_b-1-ol.svg";
...
const Application = (props) => {
  ...
  return (
    <div className={className} {...rest}>
      <img style={{ width: "100%", padding: "2rem" }} src={DocSvg} />
      <SectionHeader
        title="Pneumonia Detector AI"
        subtitle="Upload your image and get your diagnosis! As a reminder, none of you uploaded images will be stored or shared!"
        subtitleProps={{
          variant: "body1",
          color: "textPrimary",
        }}
